...
#       - The instance launched will have an available VM shape VM.Standard.E2.1.Micro
#       - The instance launched will use a latest version of Oracle Linux image (version 8)
#       - AD-3
#
...
#   * The CIDR block for the VCN and subnet (these will use the same CIDR) e.g. 10.0.0.0/16
#   * The path to the public SSH key which can be used for SSHing into the instance # ssh-keygen -t rsa -N "" -b 2048 -C "CiCd-Compute-Instance" -f ${USER_HOME}/.ssh/id_rsa
...
def get_launch_instance_details(compartment_id, availability_domain, shape, image, subnet, ssh_public_key):
    ...
    instance_metadata['user_data'] = oci.util.file_content_as_launch_instance_user_data(
        ...
        'C:/Users/Dterentev/TERDM88/user_data.sh'
    )
...
if __name__ == "__main__":
    ...
    print(sys.argv)
    print(sys.argv[3])
    print(os.path.expanduser(sys.argv[3]))
    print(os.path.expandvars(os.path.expanduser(sys.argv[3])))
